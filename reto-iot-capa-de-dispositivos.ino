...
const int B = 10;        //Resistencia a la luz (10 Lux) en KΩ
...
const char MQTT_PASS[] = "your.university.code";
const char MQTT_SUB_TOPIC[] = HOSTNAME "/";
//Tópico al que se enviarán los datos de humedad
const char MQTT_PUB_TOPIC1[] = "humedad/barranquilla/" HOSTNAME;
//Tópico al que se enviarán los datos de temperatura
const char MQTT_PUB_TOPIC2[] = "temperatura/barranquilla/" HOSTNAME;
//Tópico al que se enviarán los datos de temperatura
const char MQTT_PUB_TOPIC3[] = "luminosidad/barranquilla/" HOSTNAME;
//////////////////////////////////////////////////////
